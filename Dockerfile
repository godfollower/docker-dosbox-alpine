...
RUN apt-get update
RUN apt-get install -y libsdl2-2.0-0 libsdl2-dev libsdl2-net-dev libasound2-dev libpcap-dev libslirp-dev libfluidsynth-dev libavformat-dev libavcodec-dev libswscale-dev libfreetype-dev libxkbfile-dev libxrandr-dev build-essential automake libncurses-dev nasm curl jq
...
RUN apt-get update
RUN apt-get install -y libsdl2-2.0-0 libsdl2-net-2.0-0 libsdl-kitchensink1 fluidsynth libasound2 libavdevice59 libavcodec-extra libncurses6 libpcap0.8 libslirp0 libxkbfile1 libavdevice59 libavcodec-extra xorg pulseaudio libasound2-plugins
...
# Set port 6000 for the X-server
EXPOSE 6000
